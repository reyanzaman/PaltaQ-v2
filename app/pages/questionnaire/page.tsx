...
// Dynamically load PreQuestionnaire and PostQuestionnaire with Suspense
const PreQuestionnaire = dynamic(() => import('@/app/components/preQuestionnaire'), { suspense: true });
const PostQuestionnaire = dynamic(() => import('@/app/components/postQuestionnaire'), { suspense: true });
